...
library Compounds {
  ...
  function nextOptimalEarnBlocks(uint256 _r, uint256 callCostInWei, uint256 totalAssets, uint256 ethInWant)
    external
    pure
    returns (uint256)
  {
    ...
    uint256 t0 = (gas + FixedPointMathLib.sqrt(gas * totalAssets)) / (totalAssets * _r / PRECISION);
